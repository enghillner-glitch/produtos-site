...
assert.match(js, /Salvar Alerta/);
assert.match(js, /Alerta salvo e ativo/);
assert.match(js, /mainStatus: "active"/);
assert.doesNotMatch(js, /Enviar para análise/);
assert.doesNotMatch(js, /Quase pronto/);
assert.doesNotMatch(js, /só ficará visível após aprovação/);
...
assert.match(js, /7\.1\. Preview do alerta no app/);
assert.match(js, /7\.2\. Revise e finalize seu Alerta/);
assert.match(js, /android-notification/);
assert.match(js, /showToast\.hideTimer/);
...
assert.match(css, /toast-enter/);
assert.match(css, /toast-exit/);
assert.match(css, /left:\s*50%/);
assert.match(css, /android-preview/);
assert.match(css, /android-notification/);
assert.match(css, /choice input\[type="checkbox"\]/);
