...
| F154 | Criar backup e testar restauracao | FASE 13 - Seguranca e privacidade | parcial | 2026-06-01 | BACKUP_RESTAURACAO.md; tests/backup-restore-dry-run.mjs | Procedimento documentado e dry-run local de arquivos/schema criado; teste real com dump Supabase fica pendente. |
