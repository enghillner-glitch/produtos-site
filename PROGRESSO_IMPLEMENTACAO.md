...
| F175 | Executar homologacao funcional | FASE 15 - Testes e descontinuacao | concluida | 2026-06-01 | node --check; static-checks; unit-maintenance; unit-turnstile; backup dry-run; smoke/e2e local e producao; check-deployment-config | Homologacao automatizada executada e registrada; schema avancado aplicado no Supabase; variaveis obrigatorias cadastradas na Vercel; confirmacao final depende do novo deploy. |
