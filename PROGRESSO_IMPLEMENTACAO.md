...
| F152 | Aplicar rate limit e CAPTCHA adaptativo | FASE 13 - Seguranca e privacidade | parcial | 2026-06-01 | node --check app.js; supabase.sql | Rate limit por RLS e friccao adaptativa local existem; CAPTCHA com provedor externo fica pendente. |
