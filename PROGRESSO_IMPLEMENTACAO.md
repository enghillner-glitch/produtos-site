...
| F060 | Bloquear contatos em textos e imagens | FASE 5 - Cadastro de imoveis | parcial | 2026-06-01 | node --check app.js | Textos publicos e nomes de arquivos de imagem bloqueiam telefone, email e link; OCR de conteudo visual fica pendente de servico externo. |
