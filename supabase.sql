...
revoke execute on function public.protect_profile_role_fields() from public, anon, authenticated;
revoke execute on function public.protect_item_moderation_fields() from public, anon, authenticated;
revoke execute on function public.create_notification(uuid, text, text, text, text, uuid) from public, anon, authenticated;
revoke execute on function public.enqueue_email(uuid, text, text, text, uuid) from public, anon, authenticated;
revoke execute on function public.log_audit_event(text, text, uuid, jsonb) from public, anon, authenticated;
revoke execute on function public.expire_exchange_proposals() from public, anon, authenticated;
...
revoke execute on function public.get_my_lead_updates() from public, anon, authenticated;
revoke execute on function public.accept_exchange_proposal(uuid) from public, anon, authenticated;
revoke execute on function public.reject_exchange_proposal(uuid) from public, anon, authenticated;
revoke execute on function public.cancel_exchange_proposal(uuid) from public, anon, authenticated;
revoke execute on function public.counter_exchange_proposal(uuid, numeric, text, text) from public, anon, authenticated;
revoke execute on function public.request_final_agreement(uuid, text) from public, anon, authenticated;
revoke execute on function public.accept_final_agreement(uuid) from public, anon, authenticated;
revoke execute on function public.finalize_final_agreement(uuid) from public, anon, authenticated;
revoke execute on function public.request_agreement_cancellation(uuid, text) from public, anon, authenticated;
revoke execute on function public.resolve_agreement_cancellation(uuid, boolean, text) from public, anon, authenticated;
revoke execute on function public.mark_exchange_failed(uuid) from public, anon, authenticated;
